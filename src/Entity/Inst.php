...
#[ORM\Table(name: 'inst')]
#[ORM\UniqueConstraint(name: 'inst_code', columns: ['code'])]
//#[ApiResource(
//    normalizationContext: ['groups' => ['owner.read']],
//    denormalizationContext: ['groups' => ['owner.write']],
//)]
class Inst implements \Stringable
{
    #[ORM\Id]
    ...
    /**
     * Read-only institutions have data imported from external sources (DC, PP, Fortepan…).
     * No editing UI, no empty fields shown, no AI write-back until explicitly enabled.
     */
...
//    #[ORM\OneToMany(targetEntity: Field::class, mappedBy: 'inst', orphanRemoval: true)]
//    #[ORM\OrderBy(['orderIdx' => 'ASC'])]
    ...
    #[ORM\OneToMany(targetEntity: Core::class, mappedBy: 'inst', cascade: ['persist', 'remove'], orphanRemoval: true)]
